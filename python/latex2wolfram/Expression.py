...
class ExpressionsRow(Expression):
    """
    Class representing a expression list node in the AST
    """
    ...
    def __str__(self):
        ...
        to string
        """
        return "ExpressionsRow: " + "{"+", ".join(map(lambda el: str(el), self.values))+"}"
...
class ExpressionsRows(Expression):
    """
    Class representing a expression list node in the AST
    """
    ...
    def __str__(self):
        ...
        to string
        """
        return "ExpressionsRows: " + "{"+", ".join(map(lambda el: str(el), self.values))+"}"
